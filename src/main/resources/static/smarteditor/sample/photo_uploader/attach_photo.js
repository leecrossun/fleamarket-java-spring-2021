    ...
    function html5Upload() {	
    	...
    	sUploadURL = 'http://152.70.254.64:8080/static/smarteditor/sample/photo_uploader/file_uploader_html5.php';
    	// sUploadURL = 'http://localhost:8080/static/smarteditor/sample/photo_uploader/file_uploader_html5.php';
    	//파일을 하나씩 보내고, 결과를 받음.
	...
	function onAjaxError (e){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 	        ...
 	        sCallback : 'http://152.70.254.64:8080/static/smarteditor/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
